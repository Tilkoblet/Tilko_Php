...
$url        = $apiHost . "api/v1.0/HometaxSimpleAuth/UTERNAAZ110/JongHabSoDeugSe/SinGo";
...
file_put_contents("__BIN_FILEPATH__", base64_decode(json_decode($response)->Result->BinaryData));
