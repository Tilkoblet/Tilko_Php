...
$url        = $apiHost . "api/v1.0/FssLifeplan/RegisterStep1";
...
$bodies     = array(
    ...
    "UserName"                  => aesEncrypt($aesKey, $aesIv, file_get_contents("D:\\username.txt")),
    "BirthDate"                 => aesEncrypt($aesKey, $aesIv, file_get_contents("D:\\birthdate.txt")),
    "IdentityNumber"            => aesEncrypt($aesKey, $aesIv, file_get_contents("D:\\identitynumber.txt")),
    "MobileCorp"                => "1",
    "PhoneNumber"               => aesEncrypt($aesKey, $aesIv, file_get_contents("D:\\phonenumber.txt")),
    "RegionCode1"               => "009",
);
